...
class TestDedupFundamentalsDf:
    def test_usd_wins_over_eur(self) -> None:
        ...
        df = _make_df([
            {"ticker": "ASML", "market_cap": 100.0, "trailing_eps": 5.0,
             "_raw_currency": "EUR", "exchange": "AMS"},
            {"ticker": "ASML", "market_cap": 100.0, "trailing_eps": 5.0,
             "_raw_currency": "USD", "exchange": "NMS"},
        ])
    ...
    def test_gbp_wins_over_gbx(self) -> None:
        ...
        df = _make_df([
            {"ticker": "SHELL", "market_cap": 200.0, "trailing_eps": 3.0,
             "_raw_currency": "GBX", "exchange": "LSE"},
            {"ticker": "SHELL", "market_cap": 200.0, "trailing_eps": 3.0,
             "_raw_currency": "GBP", "exchange": "LSE-GBP"},
        ])
        result = _dedup_fundamentals_df(df)
    ...
    def test_fewer_nans_wins_as_tiebreaker(self) -> None:
        ...
        df = _make_df([
            {"ticker": "VOD", "market_cap": np.nan, "trailing_eps": np.nan,
             "operating_cashflow": np.nan, "_raw_currency": "USD",
             "exchange": "NYSE-bad"},
            {"ticker": "VOD", "market_cap": 50.0, "trailing_eps": 2.0,
             "operating_cashflow": 10.0, "_raw_currency": "USD",
             "exchange": "NYSE-good"},
        ])
        result = _dedup_fundamentals_df(df)
    ...
    def test_three_way_dedup(self) -> None:
        ...
        df = _make_df([
            {"ticker": "RIO", "market_cap": 300.0, "_raw_currency": "GBX",
             "exchange": "LSE"},
            {"ticker": "RIO", "market_cap": 300.0, "_raw_currency": "EUR",
             "exchange": "AMS"},
            {"ticker": "RIO", "market_cap": 300.0, "_raw_currency": "USD",
             "exchange": "NYSE"},
        ])
        result = _dedup_fundamentals_df(df)
    ...
    def test_unique_tickers_pass_through(self) -> None:
        ...
        df = _make_df([
            {"ticker": "AAPL", "market_cap": 3000.0, "_raw_currency": "USD",
             "exchange": "NMS"},
            {"ticker": "MSFT", "market_cap": 2800.0, "_raw_currency": "USD",
             "exchange": "NMS"},
        ])
        result = _dedup_fundamentals_df(df)
    ...
    def test_none_currency_loses(self) -> None:
        ...
        df = _make_df([
            {"ticker": "XYZ", "market_cap": 10.0, "_raw_currency": None,
             "exchange": "UNKNOWN"},
            {"ticker": "XYZ", "market_cap": 10.0, "_raw_currency": "EUR",
             "exchange": "AMS"},
        ])
        result = _dedup_fundamentals_df(df)
    ...
    def test_helper_columns_removed(self) -> None:
        ...
        df = _make_df([
            {"ticker": "ASML", "market_cap": 100.0, "_raw_currency": "USD",
             "exchange": "NMS"},
            {"ticker": "ASML", "market_cap": 100.0, "_raw_currency": "EUR",
             "exchange": "AMS"},
        ])
        result = _dedup_fundamentals_df(df)
    ...
    def test_deterministic_regardless_of_input_order(self) -> None:
        ...
        pd.testing.assert_frame_equal(
            result1.sort_index(), result2.sort_index()
        )
    ...
    def test_no_duplicates_in_result_index(self) -> None:
        ...
        df = _make_df([
            {"ticker": "A", "market_cap": 1.0, "_raw_currency": "USD",
             "exchange": "X"},
            {"ticker": "A", "market_cap": 2.0, "_raw_currency": "EUR",
             "exchange": "Y"},
            {"ticker": "B", "market_cap": 3.0, "_raw_currency": "GBX",
             "exchange": "Z"},
            {"ticker": "B", "market_cap": 4.0, "_raw_currency": "GBP",
             "exchange": "W"},
        ])
        result = _dedup_fundamentals_df(df)
    ...
    def test_mixed_dedup_and_unique(self) -> None:
        ...
        df = _make_df([
            ...
            {"ticker": "AAPL", "market_cap": 3000.0, "_raw_currency": "USD",
             "exchange": "NMS"},
            {"ticker": "SHELL", "market_cap": 200.0, "_raw_currency": "GBX",
             "exchange": "LSE"},
            {"ticker": "SHELL", "market_cap": 200.0, "_raw_currency": "GBP",
             "exchange": "LSE-GBP"},
        ])
        result = _dedup_fundamentals_df(df)
