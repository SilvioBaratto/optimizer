...
class TypeBuilder(type_builder.TypeBuilder):
    def __init__(self):
        super().__init__(classes=set(
          ["AssetFactorData","AssetView","CountryNewsSummary","CovRegimeSelection","DeltaCalibration","FactorWeightAdaptation","MacroRegimeCalibration","NewsArticle","NewsSentimentOutput","StressScenario","ViewOutput",]
        ), enums=set(
...
class BusinessCyclePhaseAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._values: set[str] = set([  "EARLY_EXPANSION",  "MID_EXPANSION",  "LATE_EXPANSION",  "RECESSION",  ])
...
class CovEstimatorChoiceAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._values: set[str] = set([  "EMPIRICAL",  "LEDOIT_WOLF",  "OAS",  "SHRUNK",  "EW",  "GERBER",  "GRAPHICAL_LASSO_CV",  "DENOISE",  "DETONE",  "IMPLIED",  ])
...
class ExpertPersonaAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._values: set[str] = set([  "VALUE_INVESTOR",  "MOMENTUM_TRADER",  "MACRO_ANALYST",  ])
...
class SentimentLabelAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._values: set[str] = set([  "BULLISH",  "BEARISH",  "NEUTRAL",  "MIXED",  ])
...
class AssetFactorDataAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "ticker",  "trailing_pe",  "price_to_book",  "ev_to_ebitda",  "momentum_12_1m",  "momentum_1m",  "rsi_14",  "return_on_equity",  "debt_to_equity",  "profit_margins",  "revenue_growth_yoy",  "earnings_growth_yoy",  "pct_from_52w_high",  "pct_from_52w_low",  "recommendation_mean",  "target_upside",  "analyst_count",  ])
...
class AssetViewAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "asset",  "direction",  "magnitude_bps",  "confidence",  "reasoning",  ])
...
class CountryNewsSummaryAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "summary",  "sentiment",  "sentiment_score",  ])
...
class CovRegimeSelectionAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "estimator",  "confidence",  "rationale",  ])
...
class DeltaCalibrationAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "delta",  "rationale",  ])
...
class FactorWeightAdaptationAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "phase",  "weights",  "rationale",  ])
...
class MacroRegimeCalibrationAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "phase",  "delta",  "tau",  "confidence",  "rationale",  ])
...
class NewsArticleAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "title",  ])
...
class NewsSentimentOutputAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "scores",  "reasoning",  ])
...
class StressScenarioAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "name",  "description",  "shocks",  "probability",  "horizon_days",  ])
...
class ViewOutputAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: set[str] = set([  "views",  "idzorek_alphas",  "rationale",  ])
