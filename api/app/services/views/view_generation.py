...
def _get_instrument_by_ticker(repo: ViewGenerationRepository, ticker: str):
...
def adjust_view_confidences(
    ...
    :func:`app.services.views.sentiment.compute_sentiment_signal`).  The
    confidence is then adjusted via
    :func:`app.services.views.sentiment.adjust_idzorek_alpha` and clamped to
    ...
    from app.services.views.sentiment import (
        adjust_idzorek_alpha,  # avoid circular import
    )
