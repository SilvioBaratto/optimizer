...
def _get_snapshot_weights_or_404(name: str, portfolio, repo: PortfolioRepository) -> dict:
...
def get_var(
    name: str,
    lookback: Annotated[int, Query(ge=1, description="Lookback window in trading days")] = 252,
