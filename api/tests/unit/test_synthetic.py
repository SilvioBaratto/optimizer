...
class TestScenarioRequestSchema:
    ...
    def test_valid_request_accepted(self) -> None:
        from app.schemas.scenarios.synthetic import ScenarioRequest
...
class TestGenerateScenarios:
    ...
    def test_returns_ndarray_and_columns(self) -> None:
        ...
        with (
            patch(
                "app.services.scenarios.synthetic_service._fetch_prices_df",
                return_value=MOCK_PRICES_DF,
            ),
            patch(
                "app.services.scenarios.synthetic_service.build_synthetic_data",
    ...
    def test_explicit_scenario_generation_preset(self) -> None:
        ...
        with (
            ...
            patch(
                "app.services.scenarios.synthetic_service.SyntheticDataConfig"
            ) as mock_config_cls,
        ):
            generate_scenarios(
                tickers=TICKERS,
...
class TestStoreAndLoadResult:
    ...
    def test_store_and_load_roundtrip(self) -> None:
        from app.services.scenarios.synthetic_service import load_result, store_result
    ...
    def test_load_nonexistent_id_returns_none(self) -> None:
        from app.services.scenarios.synthetic_service import load_result
...
class TestSyntheticRouteLarge:
    ...
    def test_get_expired_download_id_returns_404(self, client: TestClient) -> None:
        from app.services.scenarios.synthetic_service import _TEMP_DIR
