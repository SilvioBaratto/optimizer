...
down_revision: str | Sequence[str] | None = "1e14baf18033"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_financial_statements_instrument_id",
        "financial_statements",
        ["instrument_id"],
    )
    op.create_index(
        "ix_financial_statements_type_period",
        "financial_statements",
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "instrument_id", "date", name="uq_dividend_instrument_date"
        ),
    )
    ...
    op.create_index(
        "ix_analyst_recommendations_instrument_id",
        "analyst_recommendations",
        ["instrument_id"],
    )
    ...
    op.create_index(
        "ix_institutional_holders_instrument_id",
        "institutional_holders",
        ["instrument_id"],
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "instrument_id", "holder_name", name="uq_mf_holder_instrument_name"
        ),
    )
    op.create_index(
        "ix_mutualfund_holders_instrument_id", "mutualfund_holders", ["instrument_id"]
    )
    ...
    op.create_index(
        "ix_insider_transactions_instrument_id",
        "insider_transactions",
        ["instrument_id"],
    )
