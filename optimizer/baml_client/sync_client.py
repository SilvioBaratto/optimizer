...
class BamlSyncClient:
    ...
    def ClassifyBusinessCycleWithLLM(self, today: str,economic_indicators: types.EconomicIndicators,market_indicators: types.MarketIndicators,news_signals: types.MacroNewsSignals,country: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ClassifyBusinessCycleWithLLM", args={
    ...
    def GenerateBlackLittermanView(self, signal: types.StockSignalData,macro_regime: types.MacroRegimeContext,sector_context: types.SectorContext,news_signals: typing.Optional["types.StockNewsSignals"] = None,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateBlackLittermanView", args={
    ...
    def GenerateStockSignal(self, stock_data: types.ComprehensiveYFinanceData,target_date: str,macro_regime: typing.Optional["types.MacroRegimeData"] = None,recent_news: typing.Optional[typing.List["types.NewsArticle"]] = None,calculated_open_price: typing.Optional[float] = None,calculated_volatility: typing.Optional[float] = None,calculated_rsi: typing.Optional[float] = None,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateStockSignal", args={
    ...
    def RecommendBlackLittermanParameters(self, market_volatility: types.MarketVolatilityMetrics,signal_chars: types.SignalCharacteristics,macro_regime: types.MacroRegimeInput,historical_performance: types.HistoricalPerformance,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="RecommendBlackLittermanParameters", args={
    ...
    def SummarizeNewsArticles(self, news: typing.List["types.NewsArticle"],country: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="SummarizeNewsArticles", args={
    ...
    def SummarizeStockNews(self, ticker: str,news: typing.List["types.NewsArticle"],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="SummarizeStockNews", args={
...
class BamlStreamClient:
    ...
    def ClassifyBusinessCycleWithLLM(self, today: str,economic_indicators: types.EconomicIndicators,market_indicators: types.MarketIndicators,news_signals: types.MacroNewsSignals,country: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ClassifyBusinessCycleWithLLM", args={
            "today": today,"economic_indicators": economic_indicators,"market_indicators": market_indicators,"news_signals": news_signals,"country": country,
        })
    ...
    def GenerateBlackLittermanView(self, signal: types.StockSignalData,macro_regime: types.MacroRegimeContext,sector_context: types.SectorContext,news_signals: typing.Optional["types.StockNewsSignals"] = None,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateBlackLittermanView", args={
            "signal": signal,"macro_regime": macro_regime,"sector_context": sector_context,"news_signals": news_signals,
        })
    ...
    def GenerateStockSignal(self, stock_data: types.ComprehensiveYFinanceData,target_date: str,macro_regime: typing.Optional["types.MacroRegimeData"] = None,recent_news: typing.Optional[typing.List["types.NewsArticle"]] = None,calculated_open_price: typing.Optional[float] = None,calculated_volatility: typing.Optional[float] = None,calculated_rsi: typing.Optional[float] = None,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateStockSignal", args={
            "stock_data": stock_data,"target_date": target_date,"macro_regime": macro_regime,"recent_news": recent_news,"calculated_open_price": calculated_open_price,"calculated_volatility": calculated_volatility,"calculated_rsi": calculated_rsi,
        })
    ...
    def RecommendBlackLittermanParameters(self, market_volatility: types.MarketVolatilityMetrics,signal_chars: types.SignalCharacteristics,macro_regime: types.MacroRegimeInput,historical_performance: types.HistoricalPerformance,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="RecommendBlackLittermanParameters", args={
            "market_volatility": market_volatility,"signal_chars": signal_chars,"macro_regime": macro_regime,"historical_performance": historical_performance,
        })
    ...
    def SummarizeNewsArticles(self, news: typing.List["types.NewsArticle"],country: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="SummarizeNewsArticles", args={
            "news": news,"country": country,
        })
    ...
    def SummarizeStockNews(self, ticker: str,news: typing.List["types.NewsArticle"],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="SummarizeStockNews", args={
            "ticker": ticker,"news": news,
        })
...
class BamlHttpRequestClient:
    ...
    def ClassifyBusinessCycleWithLLM(self, today: str,economic_indicators: types.EconomicIndicators,market_indicators: types.MarketIndicators,news_signals: types.MacroNewsSignals,country: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ClassifyBusinessCycleWithLLM", args={
            "today": today,"economic_indicators": economic_indicators,"market_indicators": market_indicators,"news_signals": news_signals,"country": country,
        }, mode="request")
        return result
    def GenerateBlackLittermanView(self, signal: types.StockSignalData,macro_regime: types.MacroRegimeContext,sector_context: types.SectorContext,news_signals: typing.Optional["types.StockNewsSignals"] = None,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateBlackLittermanView", args={
            "signal": signal,"macro_regime": macro_regime,"sector_context": sector_context,"news_signals": news_signals,
        }, mode="request")
        return result
    def GenerateStockSignal(self, stock_data: types.ComprehensiveYFinanceData,target_date: str,macro_regime: typing.Optional["types.MacroRegimeData"] = None,recent_news: typing.Optional[typing.List["types.NewsArticle"]] = None,calculated_open_price: typing.Optional[float] = None,calculated_volatility: typing.Optional[float] = None,calculated_rsi: typing.Optional[float] = None,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateStockSignal", args={
            "stock_data": stock_data,"target_date": target_date,"macro_regime": macro_regime,"recent_news": recent_news,"calculated_open_price": calculated_open_price,"calculated_volatility": calculated_volatility,"calculated_rsi": calculated_rsi,
        }, mode="request")
        return result
    def RecommendBlackLittermanParameters(self, market_volatility: types.MarketVolatilityMetrics,signal_chars: types.SignalCharacteristics,macro_regime: types.MacroRegimeInput,historical_performance: types.HistoricalPerformance,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="RecommendBlackLittermanParameters", args={
            "market_volatility": market_volatility,"signal_chars": signal_chars,"macro_regime": macro_regime,"historical_performance": historical_performance,
        }, mode="request")
        return result
    def SummarizeNewsArticles(self, news: typing.List["types.NewsArticle"],country: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SummarizeNewsArticles", args={
            "news": news,"country": country,
        }, mode="request")
        return result
    def SummarizeStockNews(self, ticker: str,news: typing.List["types.NewsArticle"],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SummarizeStockNews", args={
            "ticker": ticker,"news": news,
        }, mode="request")
        return result
