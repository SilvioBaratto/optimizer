...
class BamlSyncClient:
    ...
    def ClassifyBusinessCycleWithLLM(self, today: str,economic_indicators: types.EconomicIndicators,market_indicators: types.MarketIndicators,news_signals: types.MacroNewsSignals,country: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ClassifyBusinessCycleWithLLM", args={
    ...
    def GenerateBlackLittermanView(self, signal: types.StockSignalData,macro_regime: types.MacroRegimeContext,sector_context: types.SectorContext,news_signals: typing.Optional["types.StockNewsSignals"] = None,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateBlackLittermanView", args={
    ...
    def GenerateStockSignal(self, stock_data: types.ComprehensiveYFinanceData,target_date: str,macro_regime: typing.Optional["types.MacroRegimeData"] = None,recent_news: typing.Optional[typing.List["types.NewsArticle"]] = None,calculated_open_price: typing.Optional[float] = None,calculated_volatility: typing.Optional[float] = None,calculated_rsi: typing.Optional[float] = None,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateStockSignal", args={
    ...
    def RecommendBlackLittermanParameters(self, market_volatility: types.MarketVolatilityMetrics,signal_chars: types.SignalCharacteristics,macro_regime: types.MacroRegimeInput,historical_performance: types.HistoricalPerformance,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="RecommendBlackLittermanParameters", args={
    ...
    def SummarizeNewsArticles(self, news: typing.List["types.NewsArticle"],country: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="SummarizeNewsArticles", args={
    ...
    def SummarizeStockNews(self, ticker: str,news: typing.List["types.NewsArticle"],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="SummarizeStockNews", args={
...
class BamlStreamClient:
    ...
    def ClassifyBusinessCycleWithLLM(self, today: str,economic_indicators: types.EconomicIndicators,market_indicators: types.MarketIndicators,news_signals: types.MacroNewsSignals,country: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.BusinessCycleClassification, types.BusinessCycleClassification]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ClassifyBusinessCycleWithLLM", args={
            "today": today,"economic_indicators": economic_indicators,"market_indicators": market_indicators,"news_signals": news_signals,"country": country,
        })
        return baml_py.BamlSyncStream[stream_types.BusinessCycleClassification, types.BusinessCycleClassification](
          __result__,
    ...
    def GenerateBlackLittermanView(self, signal: types.StockSignalData,macro_regime: types.MacroRegimeContext,sector_context: types.SectorContext,news_signals: typing.Optional["types.StockNewsSignals"] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.BlackLittermanView, types.BlackLittermanView]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateBlackLittermanView", args={
            "signal": signal,"macro_regime": macro_regime,"sector_context": sector_context,"news_signals": news_signals,
        })
        return baml_py.BamlSyncStream[stream_types.BlackLittermanView, types.BlackLittermanView](
          __result__,
    ...
    def GenerateStockSignal(self, stock_data: types.ComprehensiveYFinanceData,target_date: str,macro_regime: typing.Optional["types.MacroRegimeData"] = None,recent_news: typing.Optional[typing.List["types.NewsArticle"]] = None,calculated_open_price: typing.Optional[float] = None,calculated_volatility: typing.Optional[float] = None,calculated_rsi: typing.Optional[float] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.StockSignalOutput, types.StockSignalOutput]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateStockSignal", args={
            "stock_data": stock_data,"target_date": target_date,"macro_regime": macro_regime,"recent_news": recent_news,"calculated_open_price": calculated_open_price,"calculated_volatility": calculated_volatility,"calculated_rsi": calculated_rsi,
        })
        return baml_py.BamlSyncStream[stream_types.StockSignalOutput, types.StockSignalOutput](
          __result__,
    ...
    def RecommendBlackLittermanParameters(self, market_volatility: types.MarketVolatilityMetrics,signal_chars: types.SignalCharacteristics,macro_regime: types.MacroRegimeInput,historical_performance: types.HistoricalPerformance,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.BlackLittermanParameters, types.BlackLittermanParameters]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="RecommendBlackLittermanParameters", args={
            "market_volatility": market_volatility,"signal_chars": signal_chars,"macro_regime": macro_regime,"historical_performance": historical_performance,
        })
        return baml_py.BamlSyncStream[stream_types.BlackLittermanParameters, types.BlackLittermanParameters](
          __result__,
    ...
    def SummarizeNewsArticles(self, news: typing.List["types.NewsArticle"],country: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.MacroNewsSignals, types.MacroNewsSignals]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="SummarizeNewsArticles", args={
            "news": news,"country": country,
        })
        return baml_py.BamlSyncStream[stream_types.MacroNewsSignals, types.MacroNewsSignals](
          __result__,
    ...
    def SummarizeStockNews(self, ticker: str,news: typing.List["types.NewsArticle"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.StockNewsSignals, types.StockNewsSignals]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="SummarizeStockNews", args={
            "ticker": ticker,"news": news,
        })
        return baml_py.BamlSyncStream[stream_types.StockNewsSignals, types.StockNewsSignals](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ClassifyBusinessCycleWithLLM(self, today: str,economic_indicators: types.EconomicIndicators,market_indicators: types.MarketIndicators,news_signals: types.MacroNewsSignals,country: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ClassifyBusinessCycleWithLLM", args={
            "today": today,"economic_indicators": economic_indicators,"market_indicators": market_indicators,"news_signals": news_signals,"country": country,
        }, mode="request")
        return __result__
    def GenerateBlackLittermanView(self, signal: types.StockSignalData,macro_regime: types.MacroRegimeContext,sector_context: types.SectorContext,news_signals: typing.Optional["types.StockNewsSignals"] = None,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateBlackLittermanView", args={
            "signal": signal,"macro_regime": macro_regime,"sector_context": sector_context,"news_signals": news_signals,
        }, mode="request")
        return __result__
    def GenerateStockSignal(self, stock_data: types.ComprehensiveYFinanceData,target_date: str,macro_regime: typing.Optional["types.MacroRegimeData"] = None,recent_news: typing.Optional[typing.List["types.NewsArticle"]] = None,calculated_open_price: typing.Optional[float] = None,calculated_volatility: typing.Optional[float] = None,calculated_rsi: typing.Optional[float] = None,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateStockSignal", args={
            "stock_data": stock_data,"target_date": target_date,"macro_regime": macro_regime,"recent_news": recent_news,"calculated_open_price": calculated_open_price,"calculated_volatility": calculated_volatility,"calculated_rsi": calculated_rsi,
        }, mode="request")
        return __result__
    def RecommendBlackLittermanParameters(self, market_volatility: types.MarketVolatilityMetrics,signal_chars: types.SignalCharacteristics,macro_regime: types.MacroRegimeInput,historical_performance: types.HistoricalPerformance,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="RecommendBlackLittermanParameters", args={
            "market_volatility": market_volatility,"signal_chars": signal_chars,"macro_regime": macro_regime,"historical_performance": historical_performance,
        }, mode="request")
        return __result__
    def SummarizeNewsArticles(self, news: typing.List["types.NewsArticle"],country: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SummarizeNewsArticles", args={
            "news": news,"country": country,
        }, mode="request")
        return __result__
    def SummarizeStockNews(self, ticker: str,news: typing.List["types.NewsArticle"],
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SummarizeStockNews", args={
            "ticker": ticker,"news": news,
        }, mode="request")
        return __result__
