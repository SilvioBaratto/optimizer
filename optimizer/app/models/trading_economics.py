...
class TradingEconomicsSnapshot(BaseModel):
    ...
    source_url: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Source URL for indicators page"
    )
    ...
    num_indicators: Mapped[int] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Number of indicators fetched"
    )
    ...
    num_bond_yields: Mapped[int] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Number of bond yields fetched"
    )
...
class TradingEconomicsIndicator(BaseModel):
    ...
    value: Mapped[float] = mapped_column(
        Float,
        nullable=False,
        comment="Current indicator value"
    )

    previous: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
        comment="Previous indicator value"
    )

    unit: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        comment="Unit of measurement (%, points, etc.)"
    )

    reference: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        comment="Reference period (e.g., 'Aug/25')"
    )
    ...
    __table_args__ = (
        ...
        UniqueConstraint('snapshot_id', 'indicator_name', name='uq_te_snapshot_indicator'),
        {
...
class TradingEconomicsBondYield(BaseModel):
    ...
    raw_name: Mapped[str] = mapped_column(
        String(255),
        nullable=False,
        comment="Original bond name from Trading Economics"
    )
