...
class DatabaseManager:
    ...
    def _create_engine(self) -> None:
        ...
        logger.info(f"  - Pool size: {settings.database_pool_size if pool_class != NullPool else 'N/A'}")
        logger.info(f"  - Max overflow: {settings.database_max_overflow if pool_class != NullPool else 'N/A'}")
    ...
    def _build_connect_args(self) -> Dict[str, Any]:
        ...
        connect_args = {
            ...
            "application_name": f"scuolazoo-api-{settings.environment}",
    ...
    def get_detailed_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            "pool_class": self._engine.pool.__class__.__name__ if self._engine else None,
            "healthy": False,
