...
async def run_pipeline(
    ...
    analyzer = SignalAnalyzer(
        concurrent_batches=concurrent_batches, stocks_per_batch=stocks_per_batch
    )
...
def main():
    ...
    parser.add_argument("--date", type=str, help="Signal date (YYYY-MM-DD). Defaults to today.")
