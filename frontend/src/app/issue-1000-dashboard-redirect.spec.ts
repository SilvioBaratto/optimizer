/**
 * Source-blind example tests for issue #1000 — authored from acceptance criteria ONLY.
 *
 ...
 * layout-shell route.
 *
 * Why nothing here targets #1000's own subject (request-shape parity specs for the
 * rebalancing, portfolio-builder, and research services):
 ...
 *
 * This guard overlaps the same-named guards authored for #996–#999 — an artifact
...
describe('Issue #1000 — /dashboard route redirect', () => {
