/**
 * Source-blind example tests for issue #1001 — authored from acceptance criteria ONLY.
 *
 ...
 * layout-shell route.
 *
 * Why nothing here targets #1001's own subject (request-shape parity specs for the
 * shared universe, market, and jobs services):
 ...
 *
 * This guard overlaps the same-named guards authored for #996–#1000 — an artifact
...
describe('Issue #1001 — /dashboard route redirect', () => {
