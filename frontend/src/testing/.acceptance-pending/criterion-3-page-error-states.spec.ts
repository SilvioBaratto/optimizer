...
import { FactorResearchComponent } from '../../app/factor-research/factor-research';
import { RiskCenterComponent } from '../../app/risk-center/risk-center';
import { AttributionComponent } from '../../app/attribution/attribution';
import { RebalancingComponent } from '../../app/rebalancing/rebalancing';
...
// ---------------------------------------------------------------------------
// factor-research — primary call: POST /factors/compute
// ---------------------------------------------------------------------------

describe('Criterion 3 – FactorResearchComponent shows non-blank error state on primary API failure', () => {
  let http: HttpTestingController;
  let appRef: ApplicationRef;
  ...
  it('when the primary API call returns HTTP 500, a [role="alert"] element with non-blank text is rendered', async () => {
    const fixture = TestBed.createComponent(FactorResearchComponent);
    fixture.detectChanges();
...
// ---------------------------------------------------------------------------
// risk-center — primary call: GET /portfolio/{name}/risk/var
// ---------------------------------------------------------------------------

describe('Criterion 3 – RiskCenterComponent shows non-blank error state on primary API failure', () => {
  let http: HttpTestingController;
  let appRef: ApplicationRef;
...
// ---------------------------------------------------------------------------
// attribution — primary call: POST /attribution/brinson
// ---------------------------------------------------------------------------

describe('Criterion 3 – AttributionComponent shows non-blank error state on primary API failure', () => {
  let http: HttpTestingController;
  let appRef: ApplicationRef;
...
// ---------------------------------------------------------------------------
// rebalancing — primary call: GET /portfolio-analytics/{name}/drift
// ---------------------------------------------------------------------------

describe('Criterion 3 – RebalancingComponent shows non-blank error state on primary API failure', () => {
  let http: HttpTestingController;
  let appRef: ApplicationRef;
