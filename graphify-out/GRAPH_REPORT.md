...
## Corpus Check
- 1401 files · ~2,596,038 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23276 nodes · 46207 edges · 1677 communities (1041 shown, 636 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 8590 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99914cfe`
...
## Communities (1677 total, 636 thin omitted)

### Community 0 - "API Views & Scenarios"
Cohesion: 0.04
Nodes (53): ExpertPersona, CamelCaseModel, MacroCalibrationResponse, Calibrated Black-Litterman parameters from LLM macro regime classification., StressScenarioRequest, Tests for schema extraction issue #352.  Verifies that all inline schemas have b, MacroCalibrationResponse must live in api/app/schemas/macro_regime., api/app/schemas/views.py must exist and contain the expected schemas. (+45 more)

### Community 1 - "Optimizer Validation & Reporting"
Cohesion: 0.03
Nodes (86): LinkageMethodType, Configuration for hierarchical clustering selection.  The :class:`HierarchicalCl, Linkage method for agglomerative hierarchical clustering., DistanceConfig, DistanceEstimatorType, Configuration for distance estimator selection.  The :class:`DistanceConfig` is, Distance estimator selection., Immutable configuration for distance estimator construction.      Parameters (+78 more)
...
Cohesion: 0.1
Nodes (17): _clamp_confidence(), _clamp_delta(), _clamp_tau(), classify_macro_regime(), get_macro_calibration(), Macro regime calibration service.  Workflow:   1. Fetch recent macro indicators, Thin wrapper managing job lifecycle around the service function., Classify business cycle phase and return calibrated (δ, τ) for Black-Litterman. (+9 more)
...
Cohesion: 0.04
Nodes (67): all_succeeded(), BusinessCyclePhase, Check, Checked, CovEstimatorChoice, CovRegimeSelection, DeltaCalibration, FactorWeightAdaptation (+59 more)
...
Cohesion: 0.1
Nodes (30): compute_listing_age(), count_financial_statements(), Compute listing age in trading days for each ticker.      Parameters     -------, Count financial statements per ticker.      Parameters     ----------     statem, TestCountFinancialStatements, _apply_overrides(), _assemble_fundamentals(), _assemble_statements() (+22 more)
...
Cohesion: 0.05
Nodes (38): _load_prices(), Fetch price history and pivot to a dates x tickers matrix.      Args:         se, _fetch_price_rows(), _find_instrument(), PriceRow, Shared helpers and constants for the factor service modules.  Used across factor, Fetch raw price rows from yfinance_repository for the given tickers/dates., Lightweight container for a single price observation. (+30 more)
...
Cohesion: 0.07
Nodes (10): for_shrunk_denoised(), for_concentrated_sharpe(), for_max_sharpe_diversified(), for_max_sharpe_sector_constrained(), for_min_cvar(), Tests for optimization configs and enums., TestMeanRiskConfig, TestObjectiveFunctionType (+2 more)
...
Cohesion: 0.04
Nodes (44): FactorType, FactorValidationConfig, Individual factor identifiers., Configuration for factor validation and statistical testing.      Parameters, Configuration for factor validation and statistical testing.      Parameters, 5 observations pass default (min=3) but fail min_observations=6., TestBenjaminiHochberg, TestComputeICStats (+36 more)
...
Cohesion: 0.03
Nodes (56): Fig52EPViewTypes, Fig52EPViewTypes — multi-panel distributions for different EP view types., Multi-panel (2x3) density plots showing EP effect per view type.      Each panel, _tilt_cvar(), _tilt_mean(), _tilt_skew(), _tilt_variance(), _weighted_density() (+48 more)
...
Cohesion: 0.06
Nodes (39): AssetFactorData, AssetView, ViewOutput, _make_asset_view(), _make_factor_data(), _make_generated_views(), _make_view_output(), Unit tests for LLM-driven Black-Litterman view generation. (+31 more)
...
Cohesion: 0.1
Nodes (14): for_monthly_rolling(), for_quarterly_rolling(), for_robustness_check(), MultipleRandomizedCVConfig, Configuration for model selection and cross-validation., Configuration for :class:`skfolio.model_selection.MultipleRandomizedCV`.      Du, build_multiple_randomized_cv(), Build a :class:`MultipleRandomizedCV` cross-validator from *config*.      Parame (+6 more)
...
Cohesion: 0.16
Nodes (12): _dmm_config_univariate(), Fig42DMMvsHMM, Fig42DMMvsHMM — qualitative comparison of DMM vs HMM regime detection.  Optional, Save an informational PNG when torch/pyro-ppl are not installed., Return a DMMConfig sized for univariate financial return series.      The defaul, Fill axis background with discrete regime colour spans., Shade axis background with a continuous colour gradient.      Each day gets a ve, Qualitative DMM vs HMM regime detection on a single asset.      Panel A:  Asset (+4 more)
...
Cohesion: 0.05
Nodes (36): _compute_accruals(), _compute_amihud_illiquidity(), _compute_asset_growth(), _compute_book_to_price(), _compute_cash_flow_yield(), _compute_dividend_yield(), _compute_earnings_yield(), _compute_ebitda_to_ev() (+28 more)
...
Cohesion: 0.04
Nodes (14): GroupICAggregationConfig, Configuration for factor construction, scoring, and selection., Configuration for group-level IC aggregation.      Controls how per-factor ICs a, Configuration for stock selection from scored universe.      Parameters     ----, Configuration for stock selection from scored universe.      Parameters     ----, Configuration for macro regime factor tilts.      Per-regime multiplicative tilt, Configuration for macro regime factor tilts.      Per-regime multiplicative tilt, Configuration for group-level IC aggregation.      Controls how per-factor ICs a (+6 more)
...
Cohesion: 0.07
Nodes (20): Dynamic macro-regime sector weight bands for optimizer constraints.      Stores, SectorRegimeBandsConfig, Return sector ``(floor, cap)`` bands for the given macro regime.      Performs a, resolve_sector_bands(), Unit tests for optimizer.factors._sector_bands and SectorRegimeBandsConfig., Mutating the returned dict must not affect the module-level matrix., Construct a config where per-regime floor sum exceeds 1.0., test_floor_below_zero_raises() (+12 more)
...
Cohesion: 0.09
Nodes (18): baml_client.stream_types, baml_client.types (BAML pydantic types/enums), _cov_response(), _factor_response(), estimator_type must be a valid CovEstimatorType string value., adapt_factor_weights(), adapt_factor_weights_endpoint(), cov_estimator_type_str() (+10 more)
...
Cohesion: 0.08
Nodes (19): BlackLitterman, build_factor_integration(), Build factor-to-optimizer integration objects.      Depending on ``config.use_bl, BlackLittermanConfig, Immutable configuration for the Black-Litterman prior.      All parameters map 1, build_black_litterman(), _EmpiricalOmegaBlackLitterman, BlackLitterman variant using a pre-computed empirical omega matrix.      Extends (+11 more)
...
Cohesion: 0.04
Nodes (30): Fig43EquilibriumReturns, Fig43EquilibriumReturns — market-implied equilibrium returns by sector., Horizontal bar chart of equilibrium returns with market-cap weights.      Comput, Fig45PickMatrix, Fig45PickMatrix — heatmap of the pick matrix P for 3 canonical view types., Annotated heatmap of the pick matrix P.      Three views on a 10-asset universe:, Fig46BLPosterior, Fig46BLPosterior — grouped bar chart showing BL posterior at high/low confidence (+22 more)

### Community 146 - "Cluster 146"
Cohesion: 0.04
Nodes (26): Fig17ArithmeticVsLog, Fig17ArithmeticVsLog — dual-panel arithmetic vs log return comparison., Dual-panel: arithmetic vs log returns for 3 real assets + divergence.      Stock, Fig19ScalingComparison, Fig19ScalingComparison — naive linear scaling vs log-normal correction., Line chart: naive linear scaling vs log-normal correction using real moments., Fig21OutlierGroups, Fig21OutlierGroups — histogram with colour-coded outlier zones. (+18 more)
...
Cohesion: 0.06
Nodes (25): create_session(), delete_session(), get_job_service(), get_session(), _PipelineSession, In-process session store for the ``/portfolio-builder`` wizard.  Holds frozen ``, Insert a new session and return its hex id., Insert a new session and return its hex id. (+17 more)

### Community 152 - "Cluster 152"
Cohesion: 0.1
Nodes (20): _full_jitter(), is_transient_network_error(), Generic retry helper with exponential backoff.  Provides resilience primitives f, Detect transient network errors: HTTP rate limits and TCP resets., Full-jitter exponential backoff (AWS/Google SOTA recommendation).      Returns a, Execute *action* up to *max_retries* times with exponential-jitter backoff., retry_with_backoff(), Tests for shared resilience infrastructure (circuit breaker, retry, rate limiter (+12 more)
...
Cohesion: 0.05
Nodes (55): compute_net_backtest_returns(), _extract_summary(), _extract_weight_changes(), _extract_weights(), optimize(), End-to-end portfolio orchestration functions., Fit pipeline on full data and return final weights.      Parameters     --------, Fit pipeline on full data and return final weights.      Parameters     -------- (+47 more)
...
Cohesion: 0.02
Nodes (62): _compute_net_sharpe(), Annualised Sharpe ratio from a daily net-return Series., Annualised Sharpe ratio from a daily net-return Series., prices_df(), Tests for pipeline orchestrator functions., Field stays None if bt has no weights_per_observation attribute., Regression tests for issue #309: resilient bt.returns_df accessor.      Verifies, Build a minimal backtest-like namespace.          Uses ``types.SimpleNamespace`` (+54 more)
...
Cohesion: 0.03
Nodes (65): series, for_black_litterman(), for_heavy_tailed(), for_linear_mapping(), build_factor_bl_views(), compute_net_alpha(), estimate_factor_premia(), Estimate annualized factor premia from long-short returns.      Parameters     - (+57 more)
...
Cohesion: 0.03
Nodes (52): ActionBarComponent, b, { fixture, host }, { fixture, host, store }, { host }, optSpy, region, spy (+44 more)
...
Cohesion: 0.09
Nodes (19): Thin wrapper managing job lifecycle around the service function., Thin wrapper managing job lifecycle around the service function., Thin wrapper managing job lifecycle around the service function., _run_bulk_fetch(), _run_fred_fetch(), _run_macro_news_fetch(), get_portfolio_countries(), Service layer orchestrating macro regime data fetching and storage. (+11 more)
...
Cohesion: 0.06
Nodes (29): backtest, build_walk_forward(), Factory functions for building skfolio cross-validators., Run cross-validated prediction with a temporal cross-validator.      Thin wrappe, Build a skfolio :class:`WalkForward` cross-validator from *config*.      Paramet, run_cross_val(), TestRunCrossVal, benchmark_returns() (+21 more)
...
Cohesion: 0.06
Nodes (26): ACCEPTED, { fixture, http }, { fixture, http, tick }, mountedConfigPanel, payload, pollReq, req, runConfig (+18 more)
...
Cohesion: 0.12
Nodes (17): Ad-hoc backtest portfolio_id=None fallback contract, JobAlreadyRunningError, BacktestRun model, ExecutionRepository, Migration y5z6a7b8c9d0 (six new tables), optimize API routes, OptimizationRun model, PdfBuilder (+9 more)
...
Cohesion: 0.1
Nodes (27): 202-accept background-job + poll pattern, app.metrics, observe_endpoint_latency, time_endpoint context manager, optimization services __init__, intentional private exports for test-patching, _build_optimizer, build_pipeline service (+19 more)
...
Cohesion: 0.05
Nodes (13): App, collectSortedDates(), extractMessage(), GlobalErrorHandler, isHttpError(), notifyIfNeeded(), LoggingMiddleware, Request logging middleware (+5 more)
...
Cohesion: 0.19
Nodes (3): MacroRegimeCalibration, TestBusinessCyclePhaseEnum, TestMacroCalibrationEndpoint
...
Cohesion: 0.02
Nodes (101): DataTableComponent, BaseCurrency, BuildHistoryStepResult, ChecklistRule, CleanReturnsStepResult, CostCountryItem, CostStepResult, CoverageGateStepResult (+93 more)
...
Cohesion: 0.02
Nodes (121): Atomically replace ``session_id`` with the patched dataclass., Atomically replace ``session_id`` with the patched dataclass., update_session(), _artifact_paths(), _breakdown(), _build_regime_persistence(), _coverage_membership(), _high_vif_factors() (+113 more)
...
Cohesion: 0.18
Nodes (13): FactorIntegrationConfig, Configuration for bridging factor scores to optimization.      Parameters     --, Configuration for bridging factor scores to optimization.      Parameters     --, FactorExposureConstraints, NetAlphaResult, Bridge factor scores to portfolio optimization inputs., Enforceable linear constraints on portfolio factor exposure.      Encodes the se, Result of net alpha calculation after transaction cost deduction.      Attribute (+5 more)
...
Cohesion: 0.01
Nodes (129): ABC, Fig09BufferTurnover, Bar chart showing how buffer-zone size reduces selection turnover.      Simulate, Fig10NetAlpha, Fig10NetAlpha — Net alpha sensitivity to transaction costs., Net alpha vs transaction cost for different cost-per-unit-turnover levels., Fig11SectorBalance, Grouped bar chart showing sector distribution under three selection modes. (+121 more)
...
Cohesion: 0.03
Nodes (12): BacktestingComponent, getPortfolioTheme(), readCssVar(), registerPortfolioTheme(), EchartsCalendarHeatmapComponent, EchartsCandlestickComponent, EchartsDrawdownComponent, EchartsFactorExposureComponent (+4 more)
...
Cohesion: 0.05
Nodes (24): AnalyticsPaneComponent, MetricCard, classList, { fixture }, { fixture, host }, { fixture, store, host }, { host }, metrics (+16 more)
...
Cohesion: 0.08
Nodes (5): FactorResearchComponent, tickers(), BacktestService, FactorsService, post
...
Cohesion: 0.21
Nodes (6): Return a date exactly ``bdays`` business days after ``base``., At a calendar review date with breach, rebalancing is triggered., Between review dates, always returns False regardless of drift., Each branch surfaces a structured reason literal., _review_date(), TestShouldRebalanceHybridReason
...
Cohesion: 0.33
Nodes (6): build_bl_config_from_calibration(), Return a dict of kwargs that can construct a ``BlackLittermanConfig``.      This, MomentEstimationConfig, Immutable configuration for moment estimation and prior construction.      All p, tau and risk_aversion wire correctly into optimizer config classes., TestBuildBlConfig
...
Cohesion: 0.12
Nodes (9): Exactly trading_days elapsed is treated as a review date., One business day before the review interval → always False., Overdue review (more than trading_days elapsed) with breach → True., Hybrid with relative threshold behaves consistently., current_date == last_review_date (0 elapsed) → False., Saturday before the 21-bday mark → False.          BDay(19) from 2024-01-02 = 20, BDay(21) from last_review is a business day → True with breach., Exactly 63 bdays elapsed for quarterly config → True with breach. (+1 more)
...
Cohesion: 0.03
Nodes (55): TERMINAL_POLL, CreateSessionResponse, PIPELINE_STEPS, RunLevelConfig, StepPollResponse, StepRunResponse, m, results (+47 more)
...
Cohesion: 0.03
Nodes (38): AllocationDonutComponent, first, { fixture, store }, { fixture, store, host }, { host }, PALETTE, second, segs (+30 more)
...
Cohesion: 0.25
Nodes (6): _apply_mcap_percentile_screen(), compute_trading_frequency(), Investability screening logic., Apply exchange-percentile market-cap screen with hysteresis.      Parameters, Compute fraction of trading days with nonzero volume.      Parameters     ------, TestComputeTradingFrequency
...
Cohesion: 0.05
Nodes (33): values(), _query_sector_and_mcap(), Fig11SectorBalance — Sector balance constraints grouped bar chart., Query sector labels and market cap from the database.      Returns     -------, _cov_to_corr(), _query_sector_mapping(), Fig37GerberVsPearson — Pearson correlation vs Gerber statistic scatter., Convert a covariance matrix to a correlation matrix.      Parameters     ------- (+25 more)
...
Cohesion: 0.09
Nodes (15): PortfolioResult, Configuration and result types for the portfolio pipeline., Container for the output of a full portfolio optimisation run.      Attributes